/**
 * testnet_proof_of_operation.mjs
 * End-to-end live test on Testnet for the newly deployed VRF contract.
 */
...
async function main() {
  console.log("============================================================");
  console.log("Stellar VRF Testnet — Live End-to-End Test");
  console.log("Contract ID:   ", CONTRACT_ID);
  console.log("Oracle Account:", oracleAddr);
  console.log("============================================================\n");

  const contextStr = "Stellar VRF Live Testnet Test " + Date.now();
  const contextBuf = Buffer.from(contextStr, "utf-8");

  console.log("[1/5] Submitting request()...");
  ...
  console.log(`  Explorer Link:   https://stellar.expert/explorer/testnet/tx/${reqRes.hash}`);
  ...
  console.log(`  Explorer Link:   https://stellar.expert/explorer/testnet/tx/${fulfillRes.hash}`);
  ...
  console.log("\n============================================================");
  console.log("🎉 TESTNET LIVE TEST PASSED COMPLETELY!");
  console.log("============================================================");
  console.log(`Contract ID:       ${CONTRACT_ID}`);
